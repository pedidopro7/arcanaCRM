-- Arcana OS: attach every Supabase Auth user to the default agency workspace.
-- Safe incremental migration: does not drop business data.
...
-- Existing users are also attached. The oldest auth user becomes admin if there is no member yet.
with default_org as (
